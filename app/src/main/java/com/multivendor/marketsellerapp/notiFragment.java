...
import com.multivendor.marketsellerapp.Adapters.notiAdapter;
import com.multivendor.marketsellerapp.Models.notiModel;
import com.multivendor.marketsellerapp.ViewModels.notiViewModel;
import com.multivendor.marketsellerapp.databinding.FragmentNotiBinding;
...
public class notiFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        notiViewModel=new ViewModelProvider(getActivity()).get(notiViewModel.class);
    ...
    private void viewfunctions() {
        nfbinding.backbtn5.setOnClickListener(new View.OnClickListener() {
            @Override
