...
public class quickfragAdapter extends RecyclerView.Adapter<quickfragAdapter.viewHolder> {
    private Context mcontext;

    public quickfragAdapter(Context mcontext, List<quickorderModel .quickordResult> newordList) {
    ...
    public viewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mcontext).inflate(R.layout.quickfraglay,parent,false);
        return new viewHolder(view);
    }

    @Override
    public void onBindViewHolder(quickfragAdapter.viewHolder holder, int position) {
